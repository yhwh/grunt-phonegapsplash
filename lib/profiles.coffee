    ...
    layout:
      landscape:
        splashs: [
          ...
          { name: 'Default~iphone.png', width: 480, height: 320 }
          { name: 'Default@2x~iphone.png', width: 960, height: 640 }
          { name: 'Default-568h@2x~iphone.png', width: 1136, height: 640 }
          { name: 'Default-Portrait~ipad.png', width: 1004, height: 768 }
          { name: 'Default-Portrait@2x~ipad.png', width: 2008, height: 1536 }
          { name: 'Default-667h.png', width: 1334, height: 750 }
          { name: 'Default-736h.png', width: 2208, height: 1242 }
        ]
      portrait:
        splashs: [
